...
public class TeachersController {
    ...
    public ResponseEntity<TeacherDto> updateTeacher(
        ...
        return ResponseEntity.ok(teacherService.updateTeacher(authorization, origin, instructor, id));
    }
    ...
    public ResponseEntity<TeacherDto> deleteTeacher(
        ...
        return ResponseEntity.ok(teacherService.deleteTeacher(authorization, origin, id));
    }
}
