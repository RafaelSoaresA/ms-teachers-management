...
class InstructorListToTeacherListOutputMapperTest {
    ...
    @Test
    @DisplayName("Deve ignorar instrutores nulos na lista")
    void responseGetTeacherListMapper_withNullInstructors_shouldIgnoreNullInstructors() {
        InstructorList instructorList = new InstructorList();
        instructorList.setInstructors(List.of(null, new Instructor()));
